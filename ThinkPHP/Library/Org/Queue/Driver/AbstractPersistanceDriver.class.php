...
namespace Org\Queue\Driver;

use Org\Queue\Envelope;
use Org\Queue\DefaultEnvelope;
use Org\Queue\Serializer\Serializer;
use Org\Queue\Serializer\NativeSerializer;
 ...
 * @since   2.0
 */
abstract class AbstractPersistanceDriver implements \Org\Queue\Driver
{
    /**
     * @var Serializer
     */
