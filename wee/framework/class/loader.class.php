...
class Loader {
	...
	function func($name) {
		...
		if (file_exists($file)) {
			...
			trigger_error('Invalid Helper Function /framework/function/' . $name . '.func.php');
			return false;
		}
	}
	...
	function model($name) {
		...
		if (file_exists($file)) {
			...
			trigger_error('Invalid Model /framework/model/' . $name . '.mod.php');
			return false;
		}
	}
	...
	function classs($name) {
		...
		if (file_exists($file)) {
			...
			trigger_error('Invalid Class /framework/class/' . $name . '.class.php');
			return false;
		}
	}
	...
	function web($name) {
		...
		if (file_exists($file)) {
			...
			trigger_error('Invalid Web Helper /web/common/' . $name . '.func.php');
			return false;
		}
	}
	...
	function app($name) {
		...
		if (file_exists($file)) {
			...
			trigger_error('Invalid App Function /app/common/' . $name . '.func.php');
			return false;
		}
	}
