...
$.fn.frmDesign = function (options) {
    ...
    divhtml += '<div class="item_row"><i id="cityselect" class="fa fa-globe"></i>地区</div>';
    divhtml += '<div class="item_row"><i id="password" class="fa fa-maxcdn"></i>密码</div>';
    ...
    divhtml += '<div class="item_row"><i id="quesion" class="fa fa-book"></i>问卷</div>';
    divhtml += '<div class="item_row"><i id="baseSelect" class="fa fa-newspaper-o"></i>列表选择</div>';
    divhtml += '<div class="item_row"><i id="relation" class="fa fa-link"></i>关联频道</div>';
    divhtml += '<div class="item_row"><i id="line" class="fa fa-ellipsis-h"></i>分隔线</div>';
    divhtml += '<div class="item_row"><i id="baseinfo" class="fa fa-user"></i>登录信息</div>';
    ...
    var item_field_value_width = $(window).width() * (0.4)-145;
    //表单控件拖动
    function formdesigner_move() {
                ...
                if (!!controltype) {
                    switch (controltype) {
                        case "text":
                            ...
                            controlrowJson["control_is_mobile"] = "0";
                            controlrowJson["control_is_admin"] = "0";
                            //controlrowJson["control_only"] = "0";
                            options.controlDataJson[random_id] = controlrowJson;
                            break;
                        case "cityselect":
                            $item_control = $('<div class="item_field_label"><span>地区</span></div><div class="item_field_value">地区</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div>');
                            controlrowJson["control_label"] = "地区";
                            controlrowJson["control_field"] = "";
                            controlrowJson["control_verify"] = "";
                            controlrowJson["control_default"] = "";
                            controlrowJson["control_required"] = "0";
                            ...
                            break;
                        case "password":
                            $item_control = $('<div class="item_field_label"><span>密码</span></div><div class="item_field_value">密码</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div>');
                            controlrowJson["control_label"] = "密码";
                            controlrowJson["control_field"] = "";
                            controlrowJson["control_verify"] = "";
                            controlrowJson["control_default"] = "";
                            controlrowJson["control_required"] = "0";
                        ...
                        case "upload":
                            ...
                            break;
                        case "departmentlist":
                            $item_control = $('<div class="item_field_label"><span>单位组织</span></div><div class="item_field_value">选择单位组织</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div>');
                            controlrowJson["control_label"] = "单位组织";
                            controlrowJson["control_field"] = "";
                            controlrowJson["control_fileformat"] = "doc,xls,ppt,pdf";
                            controlrowJson["control_required"] = "0";
                            controlrowJson["control_is_mobile"] = "0";
                            ...
                            break;
                        case "baseSelect":
                            $item_control = $('<div class="item_field_label"><span>列表选择</span></div><div class="item_field_value">从列表中选择数据</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div>');
                            controlrowJson["control_label"] = "列表选择";
                            controlrowJson["control_field"] = "";
                            controlrowJson["control_fileformat"] = "doc,xls,ppt,pdf";
                            controlrowJson["control_required"] = "0";
                            controlrowJson["control_is_mobile"] = "0";
                            ...
                            break;
                        case "relation":
                            $item_control = $('<div class="item_field_label"><span>关联频道</span></div><div class="item_field_value">选择频道数据</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div>');
                            controlrowJson["control_label"] = "关联频道";
                            controlrowJson["control_field"] = "";
                            controlrowJson["control_channel"] = "";
                            controlrowJson["control_channel_index"] = "";
                            controlrowJson["control_channel_type"] = "";
                            controlrowJson["control_channel_fields"] = {};
                            controlrowJson["control_fileformat"] = "doc,xls,ppt,pdf";
                            controlrowJson["control_required"] = "0";
                            controlrowJson["control_is_mobile"] = "0";
                            controlrowJson["control_is_admin"] = "0";
                            ...
                            break;
                        case "quesion":
                            $item_control = $('<div class="item_field_label"><span>量表问卷</span></div><div class="item_field_value">问卷、量表</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div>');
                            controlrowJson["control_label"] = "量表问卷";
                            controlrowJson["control_field"] = "";
                            controlrowJson["control_fileformat"] = "doc,xls,ppt,pdf";
                            controlrowJson["control_required"] = "0";
                            controlrowJson["control_is_mobile"] = "0";
                        ...
                        case "line":
                            $item_control = $('<div class="item_field_label"><span>分隔线</span></div><div class="item_field_value">分隔线</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div>');
                            controlrowJson["control_label"] = "分隔线";
                            controlrowJson["control_field"] = "";
                            controlrowJson["control_fileformat"] = "doc,xls,ppt,pdf";
                            controlrowJson["control_required"] = "0";
                            controlrowJson["control_is_mobile"] = "0";
                            ...
                            break;
                        case "baseinfo":
                            $item_control = $('<div class="item_field_label"><span>登录信息</span></div><div class="item_field_value">登录信息</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div>');
                            controlrowJson["control_label"] = "登录信息";
                            controlrowJson["control_field"] = "";
                            controlrowJson["control_fileformat"] = "doc,xls,ppt,pdf";
                            controlrowJson["control_required"] = "0";
                            controlrowJson["control_is_mobile"] = "0";
        ...
        function frmToHtml(frmContent) {
            ...
            $.each(frmContentJson, function (id, item) {
                ...
                //必填显示
                var controlrequired = item.control_required == '1' ? '<font face="宋体">*</font>' : '<font face="宋体"></font>';
                //手机显示
                var controlshowMobile = item.control_is_mobile == '1' ? '<i  class="fa fa-tablet"></i>' : '<i></i>';
                //后台显示
                var controlshowPC = item.control_is_admin == '1' ? '<i  class="fa fa-desktop"></i>' : '<i></i>';
                switch (item.control_type) {
                    case "text":
                        _item_field_value = "文本框";
                        break;
                    case "cityselect":
                        _item_field_value = "地区";
                        break;
                    case "password":
                        _item_field_value = "密码";
                        break;
                    case "textarea":
                ...
                var $item_control = $('<div class="item_row ui-draggable" ><div class="item_field_label"><span>' + item.control_label + '</span>' + controlrequired +controlshowMobile+controlshowPC+ '</div><div class="item_field_value">' + _item_field_value + controlitemstr + '</div><div class="item_field_remove"><i  title="移除控件" class="del fa fa-close"></i></div></div>');
                if ($item_control) {
    ...
    function textProperty(e_row) {
        ...
        _html += '<div class="field_title">字段绑定<div class="addclassify"><a id="select_field"><i class="fa fa-edit"></i>选择</a></div></div>';
        ...
        _html += '<div class="field_title">字段标题</div>';
        ...
        _html += '<div class="field_control"><textarea id="control_remark" type="text" class="form-textarea" placeholder="对字段填写作详细的说明"/></div>';
        ...
        _html += '<div class="field_title">校验设置</div>';
        ...
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_only" type="checkbox" />不可重复<i title="字段中填入的值不可重复" class="help fa fa-question-circle"></i></label></div></div>';
        _html += '<div class="field_title">显示操作</div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_admin" type="checkbox" checked />电脑显示</label></div></div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_mobile" type="checkbox" checked/>手机显示</label></div></div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_admin_write" type="checkbox" checked />电脑可编辑</label></div></div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_mobile_write" type="checkbox" checked/>手机可编辑</label></div></div>';
        _html += '<div class="field_title">扫码输入</div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_scan_code" type="checkbox" />扫码码输入</label></div></div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_scan_code_tag" type="checkbox" />扫码结果可修改</label></div></div>';
        _html += '<div class="field_control"><select id="control_scan_code_type" class="form-control"><option value="qr_code">二维码</option><option value="bar_code">条型码</option></select></div>';
        _html += '<div class="field_title">高级设置</div>';
        _html += '<div class="field_control"><span  class="btn-control">联动设置</span></div>';
        _html += '<div class="field_control"><span  class="btn-control">计算公式</span></div>';
        ...
        if (rowJson.control_is_admin == 1) {
            $html.find('#control_is_admin').attr("checked", 'checked');
        } else {
            $html.find('#control_is_admin').removeAttr("checked");
        }

        if (rowJson.control_is_mobile == 1) {
            $html.find('#control_is_mobile').attr("checked", 'checked');
        } else {
            $html.find('#control_is_mobile').removeAttr("checked");
        }
        ...
        $html.find('#control_required').click(function (e) {
            ...
            if (!$(this).attr("checked")) {
                ...
                e_row.find('.item_field_label').find('font').empty();
            } else {
                value = 1;
                $(this).attr("checked", true);
                e_row.find('.item_field_label').find('font').text('*');
            }
            rowJson[$(this).attr('id')] = value;
            options.controlDataJson[e_row.attr('data-value')] = rowJson;
        });
        ...
        //手机显示勾选框点击时事件
        $html.find('#control_is_mobile').click(function (e) {
            var value = 0;
            if (!$(this).attr("checked")) {
                value = 0;
                $(this).attr("checked", false);
                e_row.find('.item_field_label').find('i').eq(0).removeAttr('class');
            } else {
                value = 1;
                $(this).attr("checked", true);
                e_row.find('.item_field_label').find('i').eq(0).attr("class", 'fa fa-tablet');
        ...
        //PC显示勾选框点击时事件
        $html.find('#control_is_admin').click(function (e) {
            var value = 0;
            if (!$(this).attr("checked")) {
                value = 0;
                $(this).attr("checked", false);
                e_row.find('.item_field_label').find('i').eq(1).removeAttr('class');

            } else {
                value = 1;
                $(this).attr("checked", true);
                e_row.find('.item_field_label').find('i').eq(1).attr("class", 'fa fa-laptop');
            }
            rowJson[$(this).attr('id')] = value;
            options.controlDataJson[e_row.attr('data-value')] = rowJson;
        });
        ...
        //选择绑定字段
        $html.find('#select_field').click(function (e) {
            layer.open({
                type: 2,
                area: ['400px', '450px'],
                fixed: false, //不固定
                maxmin: false,
                content: '/index.php?m=Admin&c=Channel&a=bindchannelfield&channelIndex=1'
            });
        });
    ...
    //地区选择控件属性
    function  cityselectProperty(e_row) {
        var _html = '';
        _html += '<div class="field_tips"><i class="fa fa-info-circle"></i><span>无样式的单行文本框</span></div>';
        _html += '<div class="field_title">字段绑定<div class="addclassify"><a><i class="fa fa-edit"></i>选择</a></div></div>';
        _html += '<div class="field_control"><div id="control_field" type="select" class="ui-select"></div></div>';//<input id="control_field" type="text" class="form-control" placeholder="必填项"/>
        _html += '<div class="field_title">字段标题</div>';
        _html += '<div class="field_control"><input id="control_label" type="text" class="form-control" placeholder="必填项"/></div>';
        _html += '<div class="field_title">字段说明</div>';
        _html += '<div class="field_control"><textarea id="control_remark" type="text" class="form-textarea" placeholder="对字段填写作详细的说明"/></div>';
        _html += '<div class="field_title">地区级别</div>';
        _html += '<div class="field_control"><select id="control_verify" class="form-control"><option value="province" selected>省</option><option value="Double">市</option><option value="area">区/县</option><option value="town">镇/乡</option></select></div>';
        _html += '<div class="field_title">级联控件</div>';
        _html += '<div class="field_control"><select id="control_verify" class="form-control"><option value="province" selected>省</option><option value="Double">市</option><option value="area">区/县</option><option value="town">镇/乡</option></select></div>';
        _html += '<div class="field_title">默认值<i title="仅在添加数据时默认填入" class="help fa fa-question-circle"></i></div>';
        _html += '<div class="field_control"><input id="control_default" type="text" class="form-control" placeholder="选择初始值"/></div>';
        _html += '<div class="field_title">校验设置</div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_required" type="checkbox" />必填</label></div></div>';
        _html += '<div class="field_title">显示操作</div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_admin" type="checkbox" checked />电脑显示</label></div></div>';
    ...
    //密码框属性
    function  passwordProperty(e_row) {
        var _html = '';
        _html += '<div class="field_tips"><i class="fa fa-info-circle"></i><span>无样式的单行文本框</span></div>';
        _html += '<div class="field_title">字段绑定<div class="addclassify"><a><i class="fa fa-edit"></i>选择</a></div></div>';
        _html += '<div class="field_control"><div id="control_field" type="select" class="ui-select"></div></div>';//<input id="control_field" type="text" class="form-control" placeholder="必填项"/>
    ...
    function radioProperty(e_row) {
        ...
        if (getRowJson.control_is_admin == 1) {
            $html.find('#control_is_admin').attr("checked", 'checked');
        } else {
            $html.find('#control_is_admin').removeAttr("checked");
        }

        if (getRowJson.control_is_mobile == 1) {
            $html.find('#control_is_mobile').attr("checked", 'checked');
        } else {
            $html.find('#control_is_mobile').removeAttr("checked");
        }
    ...
    //量表控件属性
    function quesionProperty(e_row) {
        var _html = '';
        _html += '<div class="field_tips"><i class="fa fa-info-circle"></i><span>主要用于量表或调查问卷</span></div>';
        ...
        _html += '<div class="field_title">字段说明</div>';
        _html += '<div class="field_control"><input id="control_label" type="text" class="form-control" placeholder="必填项"></div>';
        _html += '<div class="field_title">选项与得分<div class="addclassify"><a><i class="fa fa-plus"></i>添加</a></div></div>';
        _html += '<div class="field_control"><ul class="classify"></ul></div>';
        _html += '<div class="field_title">显示操作</div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_admin" type="checkbox" checked />电脑显示</label></div></div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_mobile" type="checkbox" checked/>手机显示</label></div></div>';
    ...
    //列表选择控件属性
    function baseSelectProperty(e_row) {
        var _html = '';
        _html += '<div class="field_tips"><i class="fa fa-info-circle"></i><span>弹出列表方式选择数据</span></div>';
        _html += '<div class="field_title">字段绑定<div class="addclassify"><a><i class="fa fa-edit"></i>选择</a></div></div>';
        _html += '<div class="field_control"><div id="control_field" type="select" class="ui-select"></div></div>';
        _html += '<div class="field_title">字段标题</div>';
        _html += '<div class="field_control"><input id="control_label" type="text" class="form-control" placeholder="必填项"/></div>';
        _html += '<div class="field_title">字段说明</div>';
        _html += '<div class="field_control"><textarea id="control_remark" type="text" class="form-textarea" placeholder="必填项"/></div>';


        _html += '<div class="field_title">列表选项<div class="addclassify"><a><i class="fa fa-cog"></i>配置</a></div></div>';
        _html += '<div class="field_control"><input id="control_label" type="text" class="form-control" placeholder="必填项"/></div>';

        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_admin" type="checkbox" checked />是否单选</label></div></div>';
    ...
    var row_key = null;
    //关联频道控件属性
    function relationProperty(e_row) {
        row_key = e_row.attr('data-value');
        var _html = '';
        _html += '<div class="field_tips"><i class="fa fa-info-circle"></i><span>弹出列表方式选择数据</span></div>';
        _html += '<div class="field_title">字段绑定<div class="addclassify"><a><i class="fa fa-edit"></i>选择</a></div></div>';
        _html += '<div class="field_control"><div id="control_field" type="select" class="ui-select"></div></div>';
        ...
        _html += '<div class="field_title">频道选项<div class="addclassify"><a><i class="fa fa-cog"></i>配置</a></div></div>';
        //频道
        _html += '<div class="field_control"><div class="btn-group channel-choose"><div class="input-group"><input id="control_channel" type="text" placeholder="点击选择频道" class="form-control"><input id="control_channel_index" type="hidden" class="form-control"><span class="input-group-btn"><button id="search_channel" class="btn btn-default btn-sm" type="button"><i class="fa fa-search"></i></button></span></div><ul id="channel_menu" role="menu" class="dropdown-menu" style="width: 200px;"></ul></div></div>';
        //表类型
        _html += '<div class="field_control"><div class="type-choose" style="position: relative;"><div class="field_control"><input id="control_channel_type" type="text" placeholder="点击选择表类型" class="form-control"><input id="control_channel_type_index" type="hidden" class="form-control"></div><ul id="type_menu" role="menu" class="dropdown-menu" style="width: 200px;"></ul></div></div>';

        /*_html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_admin" type="checkbox" checked />是否单选</label></div></div>';*/

        //频道字段选择
        _html += '<div class="field_title channel-field hide">频道字段选择</div>';
        _html += '<div class="field_control channel-field hide"><div id="control_channel_field" class="checkbox notclose" style="padding-left: 5px;border: 1px solid #ddd;"></div></div>';
        ...
        //选择频道
        $html.find("#control_channel").click(function(){
            var len = $html.find("#channel_menu>li").length;
            if(len == 0){
                get_channel_list($html);
            }else{
                $html.find(".channel-choose").addClass('open');
            }
        });

        //搜索频道
        $html.find("#search_channel").click(function(){
            var title = $html.find("#control_channel").val();
            get_channel_list($html, title);
        });

        //选择类型
        $html.find("#control_channel_type").click(function(){
            $html.find(".type-choose").addClass('open');
        });
    ...
    * 获取频道列表
    * **/
    function get_channel_list($html, title){

        var url = '/index.php?m=Admin&c=Channel&a=channel&action=list';
        $("#channel_menu").empty();
        var data = {};
            ...
            success: function (res) {
                if(res.result == 1){
                    $(res.data.list).each(function(i, item){
                        var li = '<li data-index="'+item.call_index+'" data-title="'+item.channel_title+'"><a>'+item.channel_title+'</a></li>';
                        $("#channel_menu").append(li);

                    });

                    $html.find("#channel_menu li").click(function(){
                        var index = $(this).attr('data-index');
                        var title = $(this).attr('data-title');
                        selected_channel(index, title);
                        //get_channel_field(index);
                        get_channel_type($html, index);
                    });

                    $(".channel-choose").addClass('open');
                }
            },
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                dialogMsg(errorThrown, -1);
    ...
    function get_channel_type($html, channel){
        var url = '/index.php?m=Admin&c=Channel&a=channel&action=type&channel='+channel;
        $("#type_menu").empty();
        $.get(url, function(res){
            if(res.result == 1){
                $(res.data).each(function(i, item){
                    var li = '<li data-index="'+item.type+'" data-title="'+item.title+'"><a>'+item.title+'</a></li>';
                    $("#type_menu").append(li);

                });

                $html.find("#type_menu li").click(function(){
                    var index = $(this).attr('data-index');
                    var title = $(this).attr('data-title');
                    selected_type(index, title);
                    get_channel_field(channel, index);
                });
    ...
    * 选择频道
    * **/
    function selected_channel(index, title){

        $("#control_channel").val(title);
        $("#control_channel_index").val(index);

        if(row_key != null){
            var rowJson = options.controlDataJson[row_key];
            rowJson['control_channel'] = title;
            rowJson['control_channel_index'] = index;
            options.controlDataJson[row_key] = rowJson;
        }
        $(".channel-choose").removeClass('open');
    }

    /*
     * 选择类型
     * **/
    function selected_type(index, title){

        $("#control_channel_type").val(title);
        $("#control_channel_type_index").val(index);

        if(row_key != null){
            var rowJson = options.controlDataJson[row_key];
            rowJson['control_channel_type'] = index;
            options.controlDataJson[row_key] = rowJson;
        }
        $(".type-choose").removeClass('open');
    }

    /*
    * 获取频道表字段
    * **/
    function get_channel_field(channel, type){
        var url = '/index.php?m=Admin&c=Channel&a=channelField&action=fields&channel='+channel+'&type='+type;
        $.get(url, function(ret){
            $("#control_channel_field").empty();
            if(ret.result == 1){
                $(ret.data).each(function(i, item){
                    var label = '<label><input class="channel_field_label" type="checkbox" name="'+item.name+'"/>'+item.title+'</label>';
                    $("#control_channel_field").append(label);

                });
                $("#control_channel_field").find('.channel_field_label').click(function(){
                    var check_val = $(this).is(':checked');
                    var filed_name = $(this).attr('name');
                    if(row_key != null){
                        var rowJson = options.controlDataJson[row_key];
                        var fieldsJson = rowJson['control_channel_fields'];
                        if(check_val){
                            //选中
                            fieldsJson[filed_name] = 1;
                        }else{
                            //取消选中
                            fieldsJson[filed_name] = 0;

                        }
                        rowJson['control_channel_fields'] = fieldsJson;

                        options.controlDataJson[row_key] = rowJson;
                    }
                });
                $(".channel-field").removeClass('hide').addClass('show');
            }
    ...
    //分隔线信息控件属性
    function lineProperty(e_row) {
        var _html = '';
        _html += '<div class="field_title">标题</div>';
        _html += '<div class="field_control"><input id="control_label" type="text" class="form-control" placeholder="必填项"/></div>';
        _html += '<div class="field_title">说明</div>';
        _html += '<div class="field_control"><textarea id="control_remark" type="text" class="form-textarea" placeholder="必填项"/></div>';
        _html += '<div class="field_title">类型</div>';
        _html += '<div class="field_control"><select id="control_type" class="form-control"><option value="0">不起分组作用</option><option value="1">起分组作用</option></select></div>';
    ...
    //登录信息控件属性
    function baseinfoProperty(e_row) {
        var _html = '';
        _html += '<div class="field_tips"><i class="fa fa-info-circle"></i><span>获取当前用户的基本信息</span></div>';
        _html += '<div class="field_title">绑定方式</div>';
        _html += '<div class="field_control"><select id="control_verify" class="form-control"><option value="0">自动生成字段</option><option value="1">绑定现有字段</option></select></div>';
        _html += '<div class="field_title">字段绑定</div>';
        _html += '<div class="field_control"><div id="control_field" type="select" class="ui-select"></div></div>';//<input id="control_field" type="text" class="form-control" placeholder="必填项"/>
        _html += '<div class="field_title">字段标题</div>';
        _html += '<div class="field_control"><input id="control_label" type="text" class="form-control" placeholder="必填项"/></div>';
        _html += '<div class="field_title">字段说明</div>';
        _html += '<div class="field_control"><textarea id="control_remark" type="text" class="form-textarea" placeholder="必填项"/></div>';
        _html += '<div class="field_title">绑定类型</div>';
        _html += '<div class="field_control"><select id="control_baseinfo" class="form-control"><option value="user_id">用户ID</option><option value="user_name">用户名</option><option value="user_cn_name">用户真实名</option><option value="user_phone">用户手机号码</option><option value="user_job">用户职位</option></select></div>';
        _html += '<div class="field_title">显示操作</div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_admin" type="checkbox" checked />电脑显示</label></div></div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_mobile" type="checkbox" checked/>手机显示</label></div></div>';
        _html += '<div class="field_control"><div class="checkbox notclose" style="padding-left: 3px;"><label><input id="control_is_admin_write" type="checkbox" checked />电脑可编辑</label></div></div>';
    ...
    $.each(frmContentJson, function (id, item) {
        ...
        switch (item.control_type) {
            ...
            case "cityselect":
                ...
                break;
            case "password":
                $item_control.append('<div class="item_field_value"><input id="' + item.control_field + '" type="password" class="form-control"  ' + controlrequired1 + ' /></div>');
                break;
            case "textarea":
