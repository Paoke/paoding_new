    ...
    <div class="server">
      <table width="100%">
        ...
        <tr>
          <td>safe_mode</td>
          <td>基础配置</td>
          <td><span class="correct_span">&radic;</span><?php echo $safe_mode; ?></td>
          <td>启用</td>
        </tr>
        <tr>
          <td>GD库</td>
          <td>必须开启</td>
          <td><span class="correct_span">&radic;</span><?php echo $gd; ?></td>
          <td>1.0</td>
        </tr>
        <tr>
          <td>mysqli</td>
      ...
      <table width="100%">
        ...
        <tr>
          <td>curl_init</td>
          <td>必须扩展</td>
          <td><span class="correct_span">&radic;</span><?php echo $curl; ?></td>
          <td>--</td>
        </tr>
        <tr>
          <td>file_put_contents</td>
          <td>建议开启</td>
          <td><span class="correct_span">&radic;</span><?php echo $file_put_contents; ?></td>
          <td>--</td>
        </tr>
      </table>
    </div>
