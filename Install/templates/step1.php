...
版权所有 (c)2015-2026，广州京墨医疗科技有限公司 保留所有权利。 
感谢您的选择，本系统 PHP + MySQL 的技术，采用ThinkPHP框架开发。
为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
本授权协议适用且仅适用于【5U互联网应用配置平台】任何版本，广州京墨医疗科技有限公司对本授权协议的最终解释权和修改权。

一、协议许可的权利
1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。
2、您可以在协议规定的约束和限制范围内修改 【5U互联网应用配置平台】 源代码或界面风格以适应您的网站要求。
3、您拥有使用本软件构建的网站全部内容所有权，并独立承担与这些内容的相关法律义务。
4、获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持内容。商业授权用户享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。

二、协议许可的权利和限制
1、未获商业授权之前，不得删除网站底部及相应的官方版权信息和链接。购买商业授权请联系京墨科技了解最新说明。
...
协议发布时间： 2017年1月1日
版本最新更新： 2017年1月1日 By 京墨科技
-----------------------------------------------------
运营团队: 京墨科技
电       话:
邮       箱:
网       址:http://www.gemmap.cn
