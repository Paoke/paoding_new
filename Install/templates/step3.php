      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="password" name="dbpw" id="dbpw" value="root" class="input" autoComplete="off" onBlur="TestDbPwd(0)"></td>
            <td><div id="J_install_tip_dbpw"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库名：</td>
            <td><input type="text" name="dbname" id="dbname" value="gemmapshop" class="input"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="gemmap_" class="input" ></td>
          </tr>
        </table>
        <!--  
		<table width="100%">
