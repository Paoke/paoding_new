    ...
    <div class="nav_box">
        <nav>
            ...
            <ul>
                ...
                <li class="active"><a href="/index.php/Home/Consulting/consultingshow">咨询</a></li>
...
<section class="refer_content">
    <div class="make">
        <label>预约成功后，我们会安排专人为您安排好具体咨询时间与地点</label>
    </div>
    ...
    <div class="show_content">
        <ul id="ul_pic">
            <li>
                <a href="javascript:;">
                    <img src="/Public/home/picture/portrait_1.jpg"/>
                    <div class="txt">图片用的暂时是小图 所以暂时是模糊的</div>
                </a>
            </li>
            <li>
                <a href="javascript:;">
                    <img src="/Public/home/picture/portrait_2.jpg"/>
                    <div class="txt">图片用的暂时是小图 所以暂时是模糊的</div>
                </a>
            </li>
            <li>
                <a href="javascript:;">
                    <img src="/Public/home/picture/portrait_3.jpg"/>
                    <div class="txt">图片用的暂时是小图 所以暂时是模糊的</div>
                </a>
            </li>
            <li>
                <a href="javascript:;">
                    <img src="/Public/home/picture/portrait_4.jpg"/>
                    <div class="txt">图片用的暂时是小图 所以暂时是模糊的</div>
                </a>
            </li>
            <li>
                <a href="javascript:;">
                    <img src="/Public/home/picture/portrait_5.jpg"/>
                    <div class="txt">图片用的暂时是小图 所以暂时是模糊的</div>
                </a>
            </li>
            <li>
                <a href="javascript:;">
                    <img src="/Public/home/picture/portrait_6.jpg"/>
                    <div class="txt">图片用的暂时是小图 所以暂时是模糊的</div>
                </a>
            </li>
        </ul>
