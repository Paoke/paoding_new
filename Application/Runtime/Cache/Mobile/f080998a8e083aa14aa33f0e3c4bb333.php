...
<div class="my_header clear">
    ...
    <div class="my_nameBox fl">
        ...
        <a href="user_authen.html" class="my_apply" ng-hide="user.status=='1'">
            <div class="my_circle">
                <img src="<?php echo (MOBILE); ?>/images/icon-my-apply.png" alt="">
            </div>
            <span>申请认证</span>
...
<div class="my_project clear">
    <div class="clear fl my_project_left">
        <a href="/index.php/Mobile/Demand/release.html" class="fl">
            <img src="<?php echo (MOBILE); ?>/images/icon-my-demand.png" alt="">
            <p>发布需求</p>
        </a>
        <a href="/index.php/Mobile/Index/release.html" class="fl">
...
<a href="" class="my_hot_intro"><img src="<?php echo (MOBILE); ?>/images/wo-xct.png" alt=""></a>
