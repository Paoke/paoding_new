...
<body>
<a href="/index.php/Mobile/Index/release.html">
    <div class="publishBtn">
        <p class="publish_p">发布技术</p>
        <img src="<?php echo (MOBILE); ?>/images/index-issue-image1.jpg" alt="">
    </div>
</a>

<a href="/index.php/Mobile/Demand/release.html">
    <div class="publishBtn">
        <p class="publish_p">发布需求</p>
        <img src="<?php echo (MOBILE); ?>/images/index-issue-image2.jpg" alt="">
    </div>
</a>
</body>
