...
<body style="padding-top:302px;">
<p class="write_tip">输入身份证号码</p>
<input class="new_name" id="idcard" type="text" placeholder="输入身份证号码">
...
<script>
    ...
    $(".change_name_save").on('click',function () {
        ...
        if(idcard==null || idcard==''){
            ...
            window.location.href='/index.php/Mobile/User/user_authen?idcard='+idcard;
        }
