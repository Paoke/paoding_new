...
<div class="demand_area">
    <p style="margin-left:30px;">技术领域</p>
...
<div class="demand_div clear"  id="choose_coopType">
    <span class="demand_name fl">合作方式</span>
    <img class='fr demand_div_jt' src="<?php echo (MOBILE); ?>/images/icon-index-issue-right.png" alt="">
    <span class="demand_name fr" id="choose_coopHtml">请选择</span>
</div>
...
<div class="slide-wrap" id="slide-wrap1">
    <div class="choose-time clear">
        ...
        <p class="fl choose-p2">请选择</p>
        <p class="fr complete" id="complete_coopType">完成</p>
    </div>
...
<div class="slide-wrap" id="slide-wrap2">
    <div class="choose-time clear">
        <p class="fl cancle">取消</p>
        <p class="fl choose-p2">请选择</p>
        <p class="fr complete" id="complete_tec">完成</p>
    </div>
    <div class="slide-line"></div>
    <div class="swiper-container" id="swiper-container-tec">
        <div class="swiper-wrapper">
            <div class="swiper-slide">原型方案</div>
            <div class="swiper-slide">核心功能</div>
            <div class="swiper-slide">实验仿真</div>
            <div class="swiper-slide">试验样品</div>
            <div class="swiper-slide">产品成型</div>
            <div class="swiper-slide">投入市场</div>
            <div class="swiper-slide">形成规模</div>
        </div>
    </div>
</div>
