...
<body ng-controller="myInfo">
    ...
    <a href="/index.php/Mobile/User/change_nickname.html">
        <div class="apply_content_box chose clear">
            ...
            <img  class='fr content_jt' src="<?php echo (MOBILE); ?>/images/icon-right2.png" alt="">
            <input style="color:#666;" class='apply_means fr' type="text" ng-value="user.nickname" disabled>
        </div>
    </a>
    <a href="/index.php/Mobile/User/binding_ale.html">
        <div class="apply_content_box chose clear">
            <span class='apply_word fl'>手机</span>
            <img  class='fr content_jt' src="<?php echo (MOBILE); ?>/images/icon-right2.png" alt="">
            <input style="color:#666;" class='apply_means fr' type="text" ng-value="user.mobile" disabled>
        </div>
    </a>
</body>
