...
<div class="ifm_head_wrap">
    <div class="ifm_head">
        <img class="ifm_deafault" src="<?php echo (MOBILE); ?>/images/icon-portrait-default.png" alt="">
        <img class="ifm_camera" src="<?php echo (MOBILE); ?>/images/icon-camera.png" alt="">
    </div>
</div>

<a href="/index.php/Mobile/User/user_authen.html">
...
<a href="#">
    <div class="apply_content_box chose clear">
        ...
        <img  class='fr content_jt' src="<?php echo (MOBILE); ?>/images/icon-right2.png" alt="">
        <input style="color:#666;" class='apply_means fr' type="text" value="凯越">
    </div>
</a>
<a href="#">
    <div class="apply_content_box chose clear">
        ...
        <img  class='fr content_jt' src="<?php echo (MOBILE); ?>/images/icon-right2.png" alt="">
        <input style="color:#666;" class='apply_means fr' type="text" value="159****6033">
    </div>
</a>
</body>
