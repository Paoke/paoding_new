...
<div class="theme_banner">
    <img class="theme_img" src="<?php echo (MOBILE); ?>/images/actibity-joint.jpg" alt="">
</div>
<!-- tab切换 -->
        ...
        <div ng-repeat="list in lists">
            <div class="activity_lately_section clear">
                ...
                <div class="activity_section_right fr">
                    ...
                    <p class="activity_right_p" ng-cloak>
...
<div class="theme_tab_content">
    <div class="theme_guest clear">
        <div class="theme_head fl">
            <img src="<?php echo (MOBILE); ?>/images/joint1.png" alt="">
        </div>
        <div class="guset_introduce fl">
            <p class="guest_name">张  霞</p>
            <p class="guest_university">海汇投资</p>
    ...
    <div class="theme_guest clear">
        <div class="theme_head fl">
            <img src="<?php echo (MOBILE); ?>/images/joint2.png" alt="">
        </div>
        <div class="guset_introduce fl">
            <p class="guest_name">舒小武</p>
            <p class="guest_university">达晨创投业务合伙人</p>
    ...
    <div class="theme_guest clear">
        <div class="theme_head fl">
            <img src="<?php echo (MOBILE); ?>/images/joint3.png" alt="">
        </div>
        <div class="guset_introduce fl">
            <p class="guest_name">郭守彬 </p>
            <p class="guest_university">广州天赐研究院副院长兼总经理助理</p>
            <!-- <p class="guest_position">国际联合研究会(JRI)副研究员</p> -->
        </div>
    </div>
    ...
    <div class="theme_guest clear">
        <div class="theme_head fl">
            <img src="<?php echo (MOBILE); ?>/images/joint4.png" alt="">
        </div>
        <div class="guset_introduce fl">
            <p class="guest_name">慕家骁</p>
            <p class="guest_university">中国电信广东研究院项目主管、高级工程师</p>
            <!-- <p class="guest_position">国际联合研究会(JRI)副研究员</p> -->
        </div>
    </div>
    ...
    <div class="theme_guest clear">
        <div class="theme_head fl">
            <img src="<?php echo (MOBILE); ?>/images/joint5.png" alt="">
        </div>
        <div class="guset_introduce fl">
            <p class="guest_name">陈亚伟</p>
            <p class="guest_university">广州三的模型设计有限公司副总经理</p>
            <!-- <p class="guest_position">国际联合研究会(JRI)副研究员</p> -->
        </div>
    </div>
    ...
    <div class="theme_guest clear">
        <div class="theme_head fl">
            <img src="<?php echo (MOBILE); ?>/images/joint6.png" alt="">
        </div>
        <div class="guset_introduce fl">
            <p class="guest_name">邓俊文</p>
            <p class="guest_university">ORFIN隆发进出口贸易有限公司总经理</p>
            <!-- <p class="guest_position">国际联合研究会(JRI)副研究员</p> -->
        </div>
    </div>
    ...
    <div class="theme_guest clear">
        <div class="theme_head fl">
            <img src="<?php echo (MOBILE); ?>/images/joint7.png" alt="">
        </div>
        <div class="guset_introduce fl">
            <p class="guest_name">凌宇辉</p>
            <p class="guest_university">广州市小盒信息科技有限公司总经理</p>
            <!-- <p class="guest_position">国际联合研究会(JRI)副研究员</p> -->
        </div>
    </div>
</div>
