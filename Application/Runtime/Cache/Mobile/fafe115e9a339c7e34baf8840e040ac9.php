...
<body>
<a href="/index.php/Mobile/User/server.html">
    <div class="apply_content_box clear">
        <span class='apply_word fl'>服务条款</span>
        <img  class='fr content_jt' src="<?php echo (MOBILE); ?>/images/icon-right2.png" alt="">
    </div>
</a>

<div class="apply_content_box clear">
    <span class='apply_word fl'>客服热线</span>
    <input class='apply_means fr' type="text" value="020-3403 1922" disabled style="background: white;">
</div>
</body>
