...
<body>
<a href="authen_company.html">
    <div class="publishBtn">
        <p class="publish_p">企业/单位认证</p>
        <img src="<?php echo (MOBILE); ?>/images/my-apply-company.png" alt="">
    </div>
</a>

<a href="authen_personal.html">
    <div class="publishBtn">
        <p class="publish_p">个人认证</p>
        <img src="<?php echo (MOBILE); ?>/images/my-apply-person.png" alt="">
    </div>
</a>
</body>
