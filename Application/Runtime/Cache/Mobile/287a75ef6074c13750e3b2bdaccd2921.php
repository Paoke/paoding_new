...
<body>
<div class="index_banner" ng-controller="bannerCtrl">
    <div class="swiper-container" id="swiper-container1">
        <div class="swiper-wrapper">
            <div class="swiper-slide" ng-repeat="banner in banners">
                <img ng-src="{{banner.ad_code}}" alt="">
            </div>
        </div>
        ...
        <div class="swiper-container" id="swiper-container2">
            <div class="swiper-wrapper">
                <div class="swiper-slide" ng-repeat="list in lists">
                    <a href="/index.php/Mobile/Index/theme_tec.html?id={{list.id}}">
...
<div class="advancedWrap" ng-controller="advancedCtrl">
    ...
    <div class="swiper-container" id="swiper-container3">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/ys1.png" alt="">
                <p class="coop_title">广州中国科学院先进技术研究所</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/ys2.png" alt="">
                <p class="coop_title">广东顺德中山大学卡内基梅隆大学...</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/ys3.png" alt="">
                <p class="coop_title">广州华新科实业有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/ys4.png" alt="">
                <p class="coop_title">广州医药研究总院有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/ys5.png" alt="">
                <p class="coop_title">广东省机器人协会</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/ys6.png" alt="">
                <p class="coop_title">深圳市机器人协会</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/ys7.png" alt="">
                <p class="coop_title">中山市物联网协会</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/ys8.png" alt="">
                <p class="coop_title">广东省清洁生产协会</p>
            </div>
...
<div class="index_main_title clear">
    <img class="fl" src="<?php echo (MOBILE); ?>/images/icon-index-cooperative-enterprise.jpg" alt="">
    <p class="fr more_tec">更多企业<img src="<?php echo (MOBILE); ?>/images/icon-right.png" alt=""></p>
</div>
<div class="index_coop_swiper">
    <div class="swiper-container" id="swiper-container4">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/1xk.png" alt="">
                <p class="coop_title">广州翔康生物技术有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/2sjl.png" alt="">
                <p class="coop_title">深圳视觉龙科技有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/3wde.png" alt="">
                <p class="coop_title">广东韦达尔科技有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/4jkwl.png" alt="">
                <p class="coop_title">广州极酷物联智能科技有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/5jmkj.png" alt="">
                <p class="coop_title">广州京墨医疗科技有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/6yyqf.png" alt="">
                <p class="coop_title">广州有园科技有限公司 </p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/7api.png" alt="">
                <p class="coop_title">柚子（北京）移动技术有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/8dps.png" alt="">
                <p class="coop_title">广州市迪士普音响科技有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/9tpkj.png" alt="">
                <p class="coop_title">广州图普网络科技有限公司</p>
            </div>
            <div class="swiper-slide">
                <img class="coop_img" src="<?php echo (MOBILE); ?>/images/10zswl.png" alt="">
                <p class="coop_title">广东中视物联技术有限公司</p>
            </div>
...
<script>
    ...
    app.controller("bannerCtrl",function ($scope,$http){
        $http({
            method:"POST",
            url:"/api.php/Index/banner?module=2",
