...
<head>
    ...
    <script type="text/javascript">
        ...
        function finishbtn() {
            bindingFrm();
            var flow = $("#flow").val();
            var url = "/index.php/Admin/Channel/channelField/action/channel_edit/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>/flow/<?php echo ($flow); ?>";
            layer.load(2);
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.result == 1) {
                        ...
                        var redirectUrl = "/index.php/Admin/Channel/channel_field_config/action/list/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>/flow/<?php echo ($flow); ?>";
                        setTimeout(function () {
