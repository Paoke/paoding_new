                                        ...
                                        <div class="span6">
                                            <div class="dataTables_paginate paging_bootstrap pagination">
                                                <ul>
                                                    ...
                                                    <?php if($page < 5): ?><!-- 页码条 -->
                                                        <?php $__FOR_START_21395__=1;$__FOR_END_21395__=$page+1;for($i=$__FOR_START_21395__;$i < $__FOR_END_21395__;$i+=1){ ?><!-- 循环四条以内 -->
                                                        ...
                                                        <?php $__FOR_START_4048__=1;$__FOR_END_4048__=6;for($i=$__FOR_START_4048__;$i < $__FOR_END_4048__;$i+=1){ ?><!-- 循环1-5 -->
                                                        ...
                                                        <?php $__FOR_START_19401__=$page_now-3;$__FOR_END_19401__=$page+1;for($i=$__FOR_START_19401__;$i < $__FOR_END_19401__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="<?php echo U('Admin/User/level/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php $__FOR_START_13006__=$page_now-4;$__FOR_END_13006__=$page+1;for($i=$__FOR_START_13006__;$i < $__FOR_END_13006__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="<?php echo U('Admin/User/level/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php else: ?>
                                                        <?php $__FOR_START_5615__=$page_now-2;$__FOR_END_5615__=$page_now+3;for($i=$__FOR_START_5615__;$i < $__FOR_END_5615__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
