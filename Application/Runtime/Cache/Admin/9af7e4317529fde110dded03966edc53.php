                                    ...
                                    <div class="span6">
                                        <div class="dataTables_paginate paging_bootstrap pagination">
                                            <ul>
                                                ...
                                                <?php if($page < 5): ?><!-- 页码条 -->
                                                    <?php $__FOR_START_13557__=1;$__FOR_END_13557__=$page+1;for($i=$__FOR_START_13557__;$i < $__FOR_END_13557__;$i+=1){ ?><!-- 循环四条以内 -->
                                                    ...
                                                    <?php $__FOR_START_25226__=1;$__FOR_END_25226__=6;for($i=$__FOR_START_25226__;$i < $__FOR_END_25226__;$i+=1){ ?><!-- 循环1-5 -->
                                                    ...
                                                    <?php $__FOR_START_12539__=$page_now-3;$__FOR_END_12539__=$page+1;for($i=$__FOR_START_12539__;$i < $__FOR_END_12539__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                            <?php elseif($i < $page ): ?>
                                                            <li><a href="/index.php/Admin/Channel/channel/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                            </li>
                                                    ...
                                                    <?php $__FOR_START_1304__=$page_now-4;$__FOR_END_1304__=$page+1;for($i=$__FOR_START_1304__;$i < $__FOR_END_1304__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                            <?php elseif($i < $page ): ?>
                                                            <li><a href="/index.php/Admin/Channel/channel/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                            </li>
                                                    ...
                                                    <?php else: ?>
                                                    <?php $__FOR_START_11121__=$page_now-2;$__FOR_END_11121__=$page_now+3;for($i=$__FOR_START_11121__;$i < $__FOR_END_11121__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
