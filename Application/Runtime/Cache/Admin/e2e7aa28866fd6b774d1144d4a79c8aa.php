                            ...
                            <header class="panel-heading panel-body">
                                ...
                                <div class="collapse navbar-collapse pull-right">
                                    <div class="navbar-right">
                                            <a href="/index.php/Admin/Wechat/img/action/page_add/wechat_id/<?php echo ($wechat_id); ?>">
                                                <button type="button" class="btn btn-default">
                                                    <i class="ace-icon fa fa-plus bigger-110"></i>添加图文回复
                                                </button>
                                            </a>
                                        </div>
                                </div>
                                ...
                                <div class="adv-table">
                                    <table class="display table table-bordered table-striped">
                                        ...
                                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr role="row" align="center" style="background:#FFFFFF;">
                                                ...
                                                <td class="text-center">
                                                    <img width="40px;" height="40px;" src="<?php echo ($list["pic"]); ?>"  type="button" />
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <a href="/index.php/Admin/Wechat/img/action/page_edit/id/<?php echo ($list["id"]); ?>/wechat_id/<?php echo ($wechat_id); ?>"
                                                       data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i
                                                            class="fa fa-pencil"></i></a>
                                                    <a href="#delModal" data-toggle="modal" class="btn btn-danger del-img"
                                                       data-url="/index.php/Admin/Wechat/img/action/del/id/<?php echo ($list["id"]); ?>"
                                                       onclick="delModal(this)"
                                                       data-id="<?php echo ($list['id']); ?>" data-name="<?php echo ($list["title"]); ?>"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            ...
                                            <div class="dataTables_paginate paging_bootstrap pagination">
                                                <ul>
                                                    <?php if($page_now == 1): ?><!-- 上一页 -->
                                                        ...
                                                        <?php else: ?>
                                                        <li class="prev">
                                                            <a href="/index.php/Admin/Wechat/img/action/page_list/page_now/<?php echo ($page_now-1); ?>/page_num/<?php echo ($page_num); ?>">
                                                                上一页
                                                            </a>
                                                        </li><?php endif; ?>   <!-- 上一页 end -->
                                                    <?php if($page < 5): ?><!-- 页码条 -->
                                                        <?php $__FOR_START_1282164210__=1;$__FOR_END_1282164210__=$page+1;for($i=$__FOR_START_1282164210__;$i < $__FOR_END_1282164210__;$i+=1){ ?><!-- 循环四条以内 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($i); ?></a></li>
                                                                <?php elseif($i < $page_now ): ?>
                                                                <li>
                                                                    <a href="/index.php/Admin/Wechat/img/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                                </li>
                                                                <?php else: ?>
                                                                <li>
                                                                    <a href="/index.php/Admin/Wechat/img/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php $__FOR_START_1903869849__=1;$__FOR_END_1903869849__=6;for($i=$__FOR_START_1903869849__;$i < $__FOR_END_1903869849__;$i+=1){ ?><!-- 循环1-5 -->
                                                        ...
                                                        <?php $__FOR_START_810200523__=$page_now-3;$__FOR_END_810200523__=$page+1;for($i=$__FOR_START_810200523__;$i < $__FOR_END_810200523__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="/index.php/Admin/Wechat/img/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php $__FOR_START_1020789433__=$page_now-4;$__FOR_END_1020789433__=$page+1;for($i=$__FOR_START_1020789433__;$i < $__FOR_END_1020789433__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="/index.php/Admin/Wechat/img/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php else: ?>
                                                        <?php $__FOR_START_1950586327__=$page_now-2;$__FOR_END_1950586327__=$page_now+3;for($i=$__FOR_START_1950586327__;$i < $__FOR_END_1950586327__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
...
<script>
    ...
    $("#select_wx").change(function () {
        var id = $(this).val();
        location.href = "/index.php/Admin/Wechat/img/action/page_list" + "/id/" + id;
