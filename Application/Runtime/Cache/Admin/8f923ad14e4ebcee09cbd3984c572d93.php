                    ...
                    <section class="panel">
                            ...
                            <div class="pull-right">
                                <div class="btn-group">
                                    <button type="submit" class="btn btn-default "
                                            onclick="ajax_submit_form()"><i class="fa fa-save"></i>保存
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <header class=" panel-body">
                            <ul id="tab_ul" class="nav nav-tabs">
                                <li data-id="aboutform" class="active">
                                    <a href="/type/home#home" data-toggle="tab" ><font color="black">网站设置</font></a>
                                </li>
                                <li data-id="sms_form" class="">
                                    <a href="/type/profile#profile" data-toggle="tab"><font color="black">短信设置</font></a>
                                </li>
                                <li data-id="email_form" class="">
                                    <a href="/type/Mail#Mail" data-toggle="tab"><font color="black">邮件设置</font></a>
                                </li>
                                <li data-id="flow_form" class="">
                                    <a href="/type/Shopping#Shopping" data-toggle="tab"><font color="black">商城设置（未开发）</font></a>
                                </li>
                                <li data-id="dist_form" class="">
                                     <a href="/type/Distribution#Distribution" data-toggle="tab"><font color="black">分销设置（未开发）</font></a>
                                 </li>
                            </ul>
                        </header>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="home">
                                    <form method="post" id="aboutform" class="postform" action="/index.php/Admin/System/setting/action/edit">
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span style="width: 8em;">上传附件最大值：</span>
                                                <select name="file_size" id="file_size" class="form-option" value="<?php echo ($vo['file_size']); ?>">
                                       ...
                                       <div class="panel-body">
                                            <div class="nav-button ">
                                                <span style="width: 8em;">上传图片最大值：</span>
                                                <select name="image_size" id="image_size" class="form-option" value="<?php echo ($vo['image_size']); ?>">
                                                    <option value="1">1M</option>
                                                    <option value="2">2M</option>
                                                    <option value="3">3M</option>
                                                    <option value="5">5M</option>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span style="width: 8em;">后台微信登录： &nbsp;</span>
                                                <div class="radio">
                                                    <label class="control-label">
                                                        <input type="radio" name="wx_scanning" value="0" checked>关
                                                    </label>
                                                    <label class="control-label">
                                                        <input type="radio" name="wx_scanning" value="1">开
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span style="width: 8em;">后台开启验证码：</span>
                                                <div class="radio">
                                                    <label class="control-label">
                                                        <input type="radio" name="login_code" value="0" checked>关
                                                    </label>
                                                    <label class="control-label">
                                                        <input type="radio" name="login_code" value="1">开
                                                    </label>
                                                </div>
                                                &nbsp&nbsp登录失败3次后开启
                                            </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span style="width: 8em;">微信注册动作： &nbsp;</span>
                                                <div class="radio">
                                                    <label class="control-label">
                                                        <input type="radio" name="wx_auto_register" value="0" checked>关闭自动注册
                                                    </label>
                                                    &nbsp &nbsp
                                                    <label class="control-label">
                                                        <input type="radio" name="wx_auto_register" value="1">自动注册，仅获取一次用户信息
                                                    </label>
                                                    &nbsp &nbsp
                                                    <label class="control-label">
                                                        <input type="radio" name="wx_auto_register" value="2">自动注册，每次都获取用户信息
                                                    </label>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span style="width: 8em;">意见反馈审核：</span>
                                                <div class="radio">
                                                    <label class="control-label">
                                                        <input type="radio" name="meb_feedback" value="0" checked>关

                                                    </label>
                                                    <label class="control-label">
                                                        <input type="radio" name="meb_feedback" value="1">开
                                                    </label>
                                ...
                                <div class="tab-pane" id="profile">
                                    <form id="sms_form" method="post" action="/index.php/Admin/System/setting/action/edit">
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span>注册启用短信：</span>
                                                <div class="radio">
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span>阿里大鱼[appkey]：</span><input type="text" name="sms_appkey"
                                                                                 class="form-control form-input"
                                                                                 style="display: inline-block;"
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span>阿里大鱼[secretKey]：</span><input type="text" name="sms_secretKey"
                                                                                    class="form-control form-input"
                                                                                    style="display: inline-block;"
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span>阿里大鱼[sign]：</span><input type="text" name="sms_sign"
                                                                               class="form-control form-input"
                                                                               style="display: inline-block;"
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span>产品名：</span><input type="text" name="sms_product"
                                                                                class="form-control form-input"
                                                                                style="display: inline-block;"
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span>短信模板名：</span><input type="text" name="sms_templateCode"
                                                                          class="form-control form-input"
                                                                          style="display: inline-block;"
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span>短信码超时时间：</span>
                                                <select name="sms_time_out" class="form-option" id="sms_time_out">
                                       ...
                                       <!--  <div class="panel-body">
                                            <div class="nav-button col-md-12">
                                                <button class="btn btn-primary fr " type="submit">保存</button>
                                            </div>
                                        </div> -->
                                    </form>
                                </div>
                                <div class="tab-pane" id="Shopping">
                                    <form id="flow_form" method="post" action="/index.php/Admin/System/setting/action/edit">
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span>默认库存：</span>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                ...
                                                <input type="number" onkeyup='this.value=this.value.replace(/\D/gi,"")'
                                                       ...
                                                       value="<?php echo ($vo['tax']); ?>" class="form-control form-input"
                                                       style="display: inline-block;"/>&nbsp;&nbsp;&nbsp;&nbsp;当买家需要发票的时候就要增加
                                                &lt;商品金额&gt;*
                                                &lt;税率&gt;的费用
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                ...
                                                <input type="number" onkeyup='this.value=this.value.replace(/\D/gi,"")'
                                                       class="form-control form-input"
                                                       min=0 name="shop_freight" value="<?php echo ($vo['shop_freight']); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                ...
                                                <div class="radio">
                                                    <label class="control-label">
                                                        <input type="radio" name="meb_comment" value="0" checked>关

                                                    </label>
                                                    <label class="control-label">
                                                        <input type="radio" name="meb_comment" value="1">开
                                                    </label>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span style=" width: 11em;">发货后多少天自动收货：</span>
                                ...
                                <div class="tab-pane" id="Mail">
                                    <form id="email_form" method="post" action="/index.php/Admin/System/setting/action/edit">
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">发送服务器：</span><input type="text" class="form-control form-input"
                                                                                      name="smtp_server"
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button "><span>发送服务器端口:</span><input type="number"
                                                                                                   class="form-control form-input"
                                                                                                   onkeyup='this.value=this.value.replace(/\D/gi,"")'
                                                                                                   name="smtp_port"
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">邮箱账号：</span><input type="email" name="smtp_user"
                                                                                   class="form-control form-input"
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">邮箱密码：</span><input type="password" name="smtp_pwd"
                                                                                   class="form-control form-input"
                                ...
                                <div class="tab-pane" id="Distribution">
                                    <form id="dist_form" method="post" action="/index.php/Admin/System/setting/action/edit">
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">分销开关:</span>
                                                <div class="radio">
                                                    <label class="control-label">
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">成为分销的条件:</span>
                                                <div class="radio">
                                                    <label class="control-label">
                                                        <input type="radio" name="condition" id="condition0" value="0">
                                                        直接成为分销
                                                    </label>
                                                    <label class="control-label">
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">分销名称：</span>
                                                <input type="text" name="name" class="form-control form-input" value="<?php echo ($vo["name"]); ?>">
                                            </div>
                                        </div>

                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">分销模式：</span>
                                                <select name="pattern" id="pattern" class="form-option" value="<?php echo ($vo["pattern"]); ?>">
                                                    <option value="0">按商品设置的分成金额</option>
                                                    <option value="1">按订单设置的分成比例</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="panel-body">
                                             <div class="nav-button ">
                                                   <span  class=" -md-1">订单默认分成比例：</span><input    type="text" name="username" placeholder="" />&nbsp;&nbsp;&nbsp;&nbsp;% 订单的百分之多少拿出来分成
                                              </div>
                                        </div> -->
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">一级分销商比例：</span>
                                                <input type="number" class="form-control form-input"
                                                       onkeyup='this.value=this.value.replace(/\D/gi,"")'
                                                       min=0 max=100 name="first_rate" value="<?php echo ($vo["first_rate"]); ?>"
                                                       placeholder="1-100">
                                                &nbsp;&nbsp;&nbsp;&nbsp;%
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">二级分销商名称：</span>
                                                <input type="text" class="form-control form-input" name="second_name"
                                                       value="<?php echo ($vo["second_name"]); ?>">
                                            </div>
                                        </div>

                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">二级分销商比例：</span>
                                                <input type="number" class="form-control form-input"
                                                       onkeyup='this.value=this.value.replace(/\D/gi,"")'
                                                       min=0 max=100 name="second_rate" value="<?php echo ($vo["second_rate"]); ?>"
                                                       placeholder="1-100">
                                                &nbsp;&nbsp;&nbsp;&nbsp;%
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">三级分销商名称：</span><input type="text" class="form-control form-input"
                                                                                      name="third_name"
                                                                                      value="<?php echo ($vo["third_name"]); ?>">
                                            </div>
                                        </div>

                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">三级分销商比例：</span>
                                                <input type="number" class="form-control form-input"
                                                       onkeyup='this.value=this.value.replace(/\D/gi,"")'
                                                       min=0 max=100 name="third_rate" value="<?php echo ($vo["third_rate"]); ?>"
                                                       placeholder="1-100">
                                                &nbsp;&nbsp;&nbsp;&nbsp;%
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                <span class=" ">分成时间:</span>
                                                <select name="date" class="form-option" id="date">
                                                    <option value="1">1天</option>
                                                    <option value="2">2天</option>
                                                    <option value="3">3天</option>
                                                    <option value="4">4天</option>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                ...
                                                <input type="number" class="form-control form-input"
                                                       onkeyup='this.value=this.value.replace(/\D/gi,"")'
                                                       min=0 name="need" value="<?php echo ($vo["need"]); ?>">
                                                &nbsp;&nbsp;&nbsp;&nbsp;元
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="nav-button ">
                                                ...
                                                <input type="number" class="form-control form-input"
                                                       onkeyup='this.value=this.value.replace(/\D/gi,"")'
                                                       min=0 name="min" value="<?php echo ($vo["min"]); ?>">
                                                &nbsp;&nbsp;&nbsp;&nbsp;元
...
<script>
    ...
    $(document).ready(function () {
        var imageSize = "<?php echo ($vo['image_size']); ?>";
        $("#image_size").val(imageSize);
        //选中附件大小
        $("#file_size").val("<?php echo ($vo['file_size']); ?>");
        //选中附件大小
