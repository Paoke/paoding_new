            ...
            <div class="wizard" data-target="#wizard-steps" style="margin-bottom: 5px">
                <ul class="flow-steps">
                    <li data-target="#step-1" class="complete">
                        <a href="/index.php/Admin/Channel/channel_field_config/action/field/flow/<?php echo ($flow); ?>/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>">
                            <span class="step">1</span>表单设计<span class="chevron"></span>
                        </a>
                    </li>
                    <li data-target="#step-2" class="complete">
                        <a  href="/index.php/Admin/Channel/channel_field_config/action/list/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>/flow/<?php echo ($flow); ?>">
                            <span class="step">2</span>列表配置<span class="chevron"></span>
                        </a>
                    </li>
                    <li data-target="#step-3" class="active">
                        <a href="/index.php/Admin/Channel/channel/action/page_edit/id/<?php echo ($channel_id); ?>/flow/<?php echo ($flow); ?>">
                                ...
                                <div class="pull-right ">
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-default" onclick="flowFinish()";>
                                         完成&nbsp;<i class="fa fa-mail-forward"></i>
                                        </a>
                                    </div>
                                </div>
                            </header>
                                        ...
                                        <div class="span6">
                                            <div class="dataTables_paginate paging_bootstrap pagination">
                                                ...
                                                <ul>
                                                    ...
                                                    <?php if($page < 5): ?><!-- 页码条 -->
                                                        <?php $__FOR_START_17927__=1;$__FOR_END_17927__=$page+1;for($i=$__FOR_START_17927__;$i < $__FOR_END_17927__;$i+=1){ ?><!-- 循环四条以内 -->
                                                        ...
                                                        <?php $__FOR_START_9012__=1;$__FOR_END_9012__=6;for($i=$__FOR_START_9012__;$i < $__FOR_END_9012__;$i+=1){ ?><!-- 循环1-5 -->
                                                        ...
                                                        <?php $__FOR_START_1373__=$page_now-3;$__FOR_END_1373__=$page+1;for($i=$__FOR_START_1373__;$i < $__FOR_END_1373__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="<?php echo U('Admin/User/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php $__FOR_START_20178__=$page_now-4;$__FOR_END_20178__=$page+1;for($i=$__FOR_START_20178__;$i < $__FOR_END_20178__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="<?php echo U('Admin/User/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php else: ?>
                                                        <?php $__FOR_START_15267__=$page_now-2;$__FOR_END_15267__=$page_now+3;for($i=$__FOR_START_15267__;$i < $__FOR_END_15267__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
