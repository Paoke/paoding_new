                                        ...
                                        <div class="span6">
                                            <div class="dataTables_paginate paging_bootstrap pagination">
                                                <ul>
                                                    ...
                                                    <?php if($page < 5): ?><!-- 页码条 -->
                                                        <?php $__FOR_START_16662__=1;$__FOR_END_16662__=$page+1;for($i=$__FOR_START_16662__;$i < $__FOR_END_16662__;$i+=1){ ?><!-- 循环四条以内 -->
                                                        ...
                                                        <?php $__FOR_START_6807__=1;$__FOR_END_6807__=6;for($i=$__FOR_START_6807__;$i < $__FOR_END_6807__;$i+=1){ ?><!-- 循环1-5 -->
                                                        ...
                                                        <?php $__FOR_START_1156__=$page_now-3;$__FOR_END_1156__=$page+1;for($i=$__FOR_START_1156__;$i < $__FOR_END_1156__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="/index.php/Admin/System/introduction/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php $__FOR_START_21613__=$page_now-4;$__FOR_END_21613__=$page+1;for($i=$__FOR_START_21613__;$i < $__FOR_END_21613__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="/index.php/Admin/System/introduction/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php else: ?>
                                                        <?php $__FOR_START_22690__=$page_now-2;$__FOR_END_22690__=$page_now+3;for($i=$__FOR_START_22690__;$i < $__FOR_END_22690__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
