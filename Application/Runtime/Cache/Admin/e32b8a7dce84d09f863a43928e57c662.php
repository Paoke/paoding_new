                                        ...
                                        <div class="span6">
                                            <div class="dataTables_paginate paging_bootstrap pagination">
                                                <ul>
                                                    ...
                                                    <?php if($page < 5): ?><!-- 页码条 -->
                                                        <?php $__FOR_START_28097__=1;$__FOR_END_28097__=$page+1;for($i=$__FOR_START_28097__;$i < $__FOR_END_28097__;$i+=1){ ?><!-- 循环四条以内 -->
                                                        ...
                                                        <?php $__FOR_START_14694__=1;$__FOR_END_14694__=6;for($i=$__FOR_START_14694__;$i < $__FOR_END_14694__;$i+=1){ ?><!-- 循环1-5 -->
                                                        ...
                                                        <?php $__FOR_START_13479__=$page_now-3;$__FOR_END_13479__=$page+1;for($i=$__FOR_START_13479__;$i < $__FOR_END_13479__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="<?php echo U('Admin/Coupon/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php $__FOR_START_32084__=$page_now-4;$__FOR_END_32084__=$page+1;for($i=$__FOR_START_32084__;$i < $__FOR_END_32084__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="<?php echo U('Admin/Coupon/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php else: ?>
                                                        <?php $__FOR_START_9469__=$page_now-2;$__FOR_END_9469__=$page_now+3;for($i=$__FOR_START_9469__;$i < $__FOR_END_9469__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
