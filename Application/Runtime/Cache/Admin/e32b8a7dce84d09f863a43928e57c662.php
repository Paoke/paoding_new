                                        ...
                                        <div class="span6">
                                            <div class="dataTables_paginate paging_bootstrap pagination">
                                                <ul>
                                                    ...
                                                    <?php if($page < 5): ?><!-- 页码条 -->
                                                        <?php $__FOR_START_27286__=1;$__FOR_END_27286__=$page+1;for($i=$__FOR_START_27286__;$i < $__FOR_END_27286__;$i+=1){ ?><!-- 循环四条以内 -->
                                                        ...
                                                        <?php $__FOR_START_17943__=1;$__FOR_END_17943__=6;for($i=$__FOR_START_17943__;$i < $__FOR_END_17943__;$i+=1){ ?><!-- 循环1-5 -->
                                                        ...
                                                        <?php $__FOR_START_2564__=$page_now-3;$__FOR_END_2564__=$page+1;for($i=$__FOR_START_2564__;$i < $__FOR_END_2564__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="<?php echo U('Admin/Coupon/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php $__FOR_START_11245__=$page_now-4;$__FOR_END_11245__=$page+1;for($i=$__FOR_START_11245__;$i < $__FOR_END_11245__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="<?php echo U('Admin/Coupon/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php else: ?>
                                                        <?php $__FOR_START_6690__=$page_now-2;$__FOR_END_6690__=$page_now+3;for($i=$__FOR_START_6690__;$i < $__FOR_END_6690__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
