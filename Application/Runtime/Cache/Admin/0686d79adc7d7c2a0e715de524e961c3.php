                      ...
                      <div class="pull-right ">
                        <div class="dataTables_paginate paging_bootstrap pagination">
                            <ul>
                                ...
                                <?php if($page < 5): ?><!-- 页码条 -->
                                    <?php $__FOR_START_29462__=1;$__FOR_END_29462__=$page+1;for($i=$__FOR_START_29462__;$i < $__FOR_END_29462__;$i+=1){ ?><!-- 循环四条以内 -->
                                    ...
                                    <?php $__FOR_START_25751__=1;$__FOR_END_25751__=6;for($i=$__FOR_START_25751__;$i < $__FOR_END_25751__;$i+=1){ ?><!-- 循环1-5 -->
                                    ...
                                    <?php $__FOR_START_1668__=$page_now-3;$__FOR_END_1668__=$page+1;for($i=$__FOR_START_1668__;$i < $__FOR_END_1668__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                            <?php elseif($i < $page ): ?>
                                            <li><a href="/index.php/Admin/PageConfig/page_config/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                            </li>
                                    ...
                                    <?php $__FOR_START_11885__=$page_now-4;$__FOR_END_11885__=$page+1;for($i=$__FOR_START_11885__;$i < $__FOR_END_11885__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                            <?php elseif($i < $page ): ?>
                                            <li><a href="/index.php/Admin/PageConfig/page_config/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                            </li>
                                    ...
                                    <?php else: ?>
                                    <?php $__FOR_START_10914__=$page_now-2;$__FOR_END_10914__=$page_now+3;for($i=$__FOR_START_10914__;$i < $__FOR_END_10914__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
