                                    ...
                                    <div class="span6">
                                        <div class="dataTables_paginate paging_bootstrap pagination">
                                            <ul>
                                                ...
                                                <?php if($page < 5): ?><!-- 页码条 -->
                                                    <?php $__FOR_START_4118__=1;$__FOR_END_4118__=$page+1;for($i=$__FOR_START_4118__;$i < $__FOR_END_4118__;$i+=1){ ?><!-- 循环四条以内 -->
                                                    ...
                                                    <?php $__FOR_START_15767__=1;$__FOR_END_15767__=6;for($i=$__FOR_START_15767__;$i < $__FOR_END_15767__;$i+=1){ ?><!-- 循环1-5 -->
                                                    ...
                                                    <?php $__FOR_START_27524__=$page_now-3;$__FOR_END_27524__=$page+1;for($i=$__FOR_START_27524__;$i < $__FOR_END_27524__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                            <?php elseif($i < $page ): ?>
                                                            <li>
                                                                <a href="<?php echo U('Admin/User/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                    ...
                                                    <?php $__FOR_START_12141__=$page_now-4;$__FOR_END_12141__=$page+1;for($i=$__FOR_START_12141__;$i < $__FOR_END_12141__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                            <?php elseif($i < $page ): ?>
                                                            <li>
                                                                <a href="<?php echo U('Admin/User/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                    ...
                                                    <?php else: ?>
                                                    <?php $__FOR_START_6050__=$page_now-2;$__FOR_END_6050__=$page_now+3;for($i=$__FOR_START_6050__;$i < $__FOR_END_6050__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
