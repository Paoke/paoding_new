...
<script type="text/javascript">
    ...
    function changeStatus(mod, id, status){
        var url = "/index.php/Admin/Activity/examine/action/update_status/channel/<?php echo ($channel); ?>/type/1";
    ...
    function get_all(obj){
        var url = "/index.php/Admin/Activity/examine/action/list/channel/<?php echo ($channel); ?>/type/10";
    ...
    function get_audit(obj){
        var url="/index.php/Admin/Activity/examine/action/audit/channel/<?php echo ($channel); ?>/type/10";
    ...
    function get_yes(obj){
        ...
        var url="/index.php/Admin/Activity/examine/action/info/channel/<?php echo ($channel); ?>/type/10";
    ...
    //不通过
    function get_no(obj){
        var url="/index.php/Admin/Activity/examine/action/issue/channel/<?php echo ($channel); ?>/type/10";
    ...
    function get_record(obj){
        var url="/index.php/Admin/Activity/examine/action/record/channel/<?php echo ($channel); ?>/type/10";
