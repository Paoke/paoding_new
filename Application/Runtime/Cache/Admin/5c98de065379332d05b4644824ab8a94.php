...
<style type="text/css">
    ...
    .current_tr th:nth-of-type(2){min-width:80px;}
    .current_tr th:nth-of-type(5){min-width:80px;}
    .current_tr th:nth-of-type(8){min-width:50px;}
    .current_tr th:nth-of-type(14){min-width:50px;}
    .current_tr th:nth-of-type(15){min-width:50px;}
                    ...
                    <section class="panel">
                        <header class="panel-heading panel-body">
                            ...
                            <form role="search" method="post" >
                                ...
                                <div class="btn-group">
                                    <a href="/index.php/Admin/Activity/activity/action/page_add/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>" title="新增内容"
                                    ...
                                    <a href="/index.php/Admin/Activity/activity/action/recycle_page_list/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>" title="垃圾桶"
                            ...
                            <div class="pull-right" style="margin-right:5px;">
                                <div class="btn-group" id="op_div">
                                    <a href="#myModal2" id="sort" data-toggle="modal" class="btn btn-default" onclick="loadCategory(0)"><i class="fa fa-search"></i>全部类别</a>
                                </div>
                            </div>
                            <div class="pull-right">
                                <div class="input-group search-form">
                                    <input type="text" class="form-control" name="keyword" id="keyword" placeholder="搜索名称" value="<?php echo ($_POST['keyword']); ?>">
                                ...
                                <table id="list-table" class="table table-bordered table-hover" role="grid"
                                    ...
                                    <tr role="row " class="current_tr">
                                        <?php if($info_field): ?><th valign="middle">ID</th>
                                            ...
                                            <th width="56px" valign="middle">状态</th>
                                            <th width="8%">启用/停用 </th>
                                            <!--<th width="71px" valign="middle">标签管理</th>-->
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn btn-default"
                                                       href="/index.php/Admin/Activity/activity/action/page_edit/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>/id/<?php echo ($vo["id"]["data"]); ?>/page_now/<?php echo ($page_now); ?>/page_num/<?php echo ($page_num); ?>/category_id/<?php echo ($category_id); ?>"
                                                       title="编辑"><i class="fa fa-pencil"></i></a>

                                                        <?php if($lead[is_copy] == 1): ?><a class="btn btn-default"
                                                    ...
                                                    <a class="btn btn-default"
                                                       href="/index.php/Admin/Activity/ticket_cat/action/page_list/channel/<?php echo ($channel); ?>/type/6/data_id/<?php echo ($vo["id"]["data"]); ?>"
                                                       title="票价配置"><i class="fa fa-money"></i></a>
                                                    <a class="btn btn-default"
                                                       href="/index.php/Admin/WeifanTest/test/action/page_list/activity_id/<?php echo ($vo["id"]["data"]); ?>/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>"
                                                       title="问卷配置"><i class="fa fa-columns"></i></a>
                                                    <a class="btn btn-default" title="二维码" onclick="qrcode('<?php echo ($vo["id"]["data"]); ?>')"><i class="fa fa-qrcode"></i></a>
                                                    <a href="#delModal" data-toggle="modal" class="btn btn-default"
                                                       data-name="<?php echo ($vo["title"]["data"]); ?>" title="删除"
                                                       data-url="/index.php/Admin/Activity/activity/action/del/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>/id/<?php echo ($vo["id"]["data"]); ?>"
                                        ...
                                        <div class="dataTables_paginate paging_bootstrap pagination">
                                            <ul>
                                                <?php if($page_now == 1): ?><!-- 上一页 -->
                                                    ...
                                                    <?php else: ?>
                                                    <li class="prev">
                                                        <a href="/index.php/Admin/Activity/activity/action/page_list/page_now/<?php echo ($page_now-1); ?>/page_num/<?php echo ($page_num); ?>/category_id/<?php echo ($category_id); ?>">
                                                            上一页
                                                        </a>
                                                    </li><?php endif; ?>   <!-- 上一页 end -->

                                                <?php if($page < 5): ?><!-- 页码条 -->
                                                    <?php $__FOR_START_19539__=1;$__FOR_END_19539__=$page+1;for($i=$__FOR_START_19539__;$i < $__FOR_END_19539__;$i+=1){ ?><!-- 循环四条以内 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href=""><?php echo ($i); ?></a></li>
                                                            <?php elseif($i < $page_now ): ?>
                                                            <li>
                                                                <a href="/index.php/Admin/Activity/activity/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>/category_id/<?php echo ($category_id); ?>"><?php echo ($i); ?></a>
                                                            </li>
                                                            <?php else: ?>
                                                            <li>
                                                                <a href="/index.php/Admin/Activity/activity/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>/category_id/<?php echo ($category_id); ?>"><?php echo ($i); ?></a>
                                                    ...
                                                    <?php $__FOR_START_31120__=1;$__FOR_END_31120__=6;for($i=$__FOR_START_31120__;$i < $__FOR_END_31120__;$i+=1){ ?><!-- 循环1-5 -->
                                                    ...
                                                    <?php $__FOR_START_21129__=$page_now-3;$__FOR_END_21129__=$page+1;for($i=$__FOR_START_21129__;$i < $__FOR_END_21129__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                            <?php elseif($i < $page ): ?>
                                                            <li>
                                                                <a href="/index.php/Admin/Activity/activity/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>/category_id/<?php echo ($category_id); ?>"><?php echo ($i); ?></a>
                                                    ...
                                                    <?php $__FOR_START_4750__=$page_now-4;$__FOR_END_4750__=$page+1;for($i=$__FOR_START_4750__;$i < $__FOR_END_4750__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                            <?php elseif($i < $page ): ?>
                                                            <li>
                                                                <a href="/index.php/Admin/Activity/activity/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>/category_id/<?php echo ($category_id); ?>"><?php echo ($i); ?></a>
                                                    ...
                                                    <?php else: ?>
                                                    <?php $__FOR_START_23215__=$page_now-2;$__FOR_END_23215__=$page_now+3;for($i=$__FOR_START_23215__;$i < $__FOR_END_23215__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
...
<script type="text/javascript">
    ...
    function qrcode(id){
        var url = "/index.php/Admin/Activity/activity/action/qrcode/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>/id/"+id;
    ...
    function loadCategory(obj){
        ...
        var url = "/index.php/Admin/Activity/category/action/list/channel/<?php echo ($channel); ?>/type/2";
    ...
    function searchByTitle(id) {
        ...
        window.location.href=" /index.php/Admin/Activity/activity/action/page_list/channel/<?php echo ($channel); ?>/type/1/category_id/"+id;
