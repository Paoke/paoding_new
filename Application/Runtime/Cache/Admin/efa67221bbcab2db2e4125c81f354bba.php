                                        ...
                                        <div class="span6">
                                            <div class="dataTables_paginate paging_bootstrap pagination">
                                                <ul>
                                                    ...
                                                    <?php if($page < 5): ?><!-- 页码条 -->
                                                        <?php $__FOR_START_17228__=1;$__FOR_END_17228__=$page+1;for($i=$__FOR_START_17228__;$i < $__FOR_END_17228__;$i+=1){ ?><!-- 循环四条以内 -->
                                                        ...
                                                        <?php $__FOR_START_32661__=1;$__FOR_END_32661__=6;for($i=$__FOR_START_32661__;$i < $__FOR_END_32661__;$i+=1){ ?><!-- 循环1-5 -->
                                                        ...
                                                        <?php $__FOR_START_26794__=$page_now-3;$__FOR_END_26794__=$page+1;for($i=$__FOR_START_26794__;$i < $__FOR_END_26794__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="/index.php/Admin/User/user/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php $__FOR_START_3227__=$page_now-4;$__FOR_END_3227__=$page+1;for($i=$__FOR_START_3227__;$i < $__FOR_END_3227__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                            <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                                <?php elseif($i < $page ): ?>
                                                                <li>
                                                                    <a href="/index.php/Admin/User/user/action/page_list/page_now/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                        ...
                                                        <?php else: ?>
                                                        <?php $__FOR_START_18488__=$page_now-2;$__FOR_END_18488__=$page_now+3;for($i=$__FOR_START_18488__;$i < $__FOR_END_18488__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
