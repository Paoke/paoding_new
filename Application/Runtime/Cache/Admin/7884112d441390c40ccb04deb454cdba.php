                                    ...
                                    <div class="panel-body formadd">
                                        ...
                                        <div class="pull-right">
                                            <div class="btn-group" style="margin-top: -5px;">
                                                <a href="/index.php/Admin/Article/category/action/page_add/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>"
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <input type="text" class="form-control" id="keyword" name="keyword" value="<?php echo ($_POST['keyword']); ?>"  placeholder="请输入类别名称">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn btn-default"
                                                       href="/index.php/Admin/Article/category/action/page_edit/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>/id/<?php echo ($vo["id"]["data"]); ?>"
                                                    ...
                                                    <a href="#delModal" data-toggle="modal" class="btn btn-default"
                                                       ...
                                                       data-url="/index.php/Admin/Article/category/action/del/channel/<?php echo ($channel); ?>/type/<?php echo ($type); ?>/id/<?php echo ($vo["id"]["data"]); ?>"
                                    ...
                                    <div class="span6">
                                        <div class="dataTables_paginate paging_bootstrap pagination">
                                            <ul>
                                                ...
                                                <?php if($page < 5): ?><!-- 页码条 -->
                                                    <?php $__FOR_START_29922__=1;$__FOR_END_29922__=$page+1;for($i=$__FOR_START_29922__;$i < $__FOR_END_29922__;$i+=1){ ?><!-- 循环四条以内 -->
                                                    ...
                                                    <?php $__FOR_START_20595__=1;$__FOR_END_20595__=6;for($i=$__FOR_START_20595__;$i < $__FOR_END_20595__;$i+=1){ ?><!-- 循环1-5 -->
                                                    ...
                                                    <?php $__FOR_START_31536__=$page_now-3;$__FOR_END_31536__=$page+1;for($i=$__FOR_START_31536__;$i < $__FOR_END_31536__;$i+=1){ ?><!-- 循环当前页为倒数第二页时 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                            <?php elseif($i < $page ): ?>
                                                            <li>
                                                                <a href="<?php echo U('Admin/User/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                    ...
                                                    <?php $__FOR_START_17321__=$page_now-4;$__FOR_END_17321__=$page+1;for($i=$__FOR_START_17321__;$i < $__FOR_END_17321__;$i+=1){ ?><!-- 循环当前页为最后一页时 -->
                                                        <?php if($i == $page_now ): ?><li class="active"><a href="#"><?php echo ($page_now); ?></a></li>
                                                            <?php elseif($i < $page ): ?>
                                                            <li>
                                                                <a href="<?php echo U('Admin/User/index/page_now');?>/<?php echo ($i); ?>/page_num/<?php echo ($page_num); ?>"><?php echo ($i); ?></a>
                                                    ...
                                                    <?php else: ?>
                                                    <?php $__FOR_START_32046__=$page_now-2;$__FOR_END_32046__=$page_now+3;for($i=$__FOR_START_32046__;$i < $__FOR_END_32046__;$i+=1){ ?><!-- 循环除了前五条 和后五条 -->
...
//        }
    ...
    function listSon(obj, id) {
        var str = '';
        var url = "/index.php/Admin/Article/category/action/page_list/id/" + id + "/type/<?php echo ($type); ?>";
        ...
        if (faClass == "fa fa-caret-right") {
            $.get(url, function (res) {
                $.each(res.data, function (i, item) {
                    ...
                    str += '<td class="text-center">' +
                            ...
                            '</td>';
                    str += '<td><input type="text" onchange=\'updateSort("","article_category","id",' +
                    ...
                    str += '<a class="btn btn-default" ' +
                            'href="/index.php/Admin/Article/category/action/page_edit/id/' + item.id +
                    ...
                    str += '<a href="#delModal" data-toggle="modal" class="btn btn-default delModal"' +
                            ...
                            'data-url="/index.php/Admin/Article/category/action/del/id/' + item.id + '"' +
            ...
            var url = "/index.php/Admin/Article/category/action/page_list/id/" + id +
