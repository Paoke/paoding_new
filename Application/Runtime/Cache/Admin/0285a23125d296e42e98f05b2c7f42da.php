                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" method="post" id="spec_form">
                                ...
                                <div class="form-group" id="tab_ul">
                                    <div class="col-sm-9" style="min-width:90%;" class="active">
                                        <textarea name="content" id="content" ><?php echo ($vo["introduction_register_law"]); ?></textarea>
                                    </div>
                                </div>
                            </form>
...
<script >
    ...
    function ajax_submit_form(form_id) {
        ...
        var action ="/index.php/Admin/System/terms/action/edit";
