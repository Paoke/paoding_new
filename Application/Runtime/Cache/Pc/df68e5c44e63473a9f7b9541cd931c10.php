...
<div class="center">
	...
	<nav class="navigation">
		<ul class="navigation-list ul-reset">
			...
			<li class="navigation-item ib">
				<a href="/index.php/Pc/Article/data_list/channel/xq" class='navigation-link selected-link'>
					需求
				</a>
			</li>
			<li class="navigation-item ib">
	...
	<div class="science_list outside" >
		<div class="center">
			...
			<div class="science_tab">
				...
				<ul class="science_tabUl">
					<li class="science_tabLi">
						<a class='science_tabLi_a science_tabLi_a_active' href="/index.php/Pc/Article/data_list/channel/<?php echo ($channel); ?>/type/1">全部</a>
					</li>
			...
			<div class="science_new">
				<!--<a class='science_new_tab <?php if(($_GET['listorder'] == 'new') OR ($_GET['listorder'] == null)): ?>science_new_tab_active<?php endif; ?>' href="<?php echo U('Task/index',array('cat_id'=>$_GET['cat_id'],'listorder'=>'new'));?>">最新发布</a>-->
				<a class='science_new_tab science_new_tab_active' @click="getNew()">最新发布</a>
				<span class="science_new_link"></span>
				<!--<a class='science_new_tab <?php if($_GET['listorder'] == 'focus'): ?>science_new_tab_active<?php endif; ?>' href="<?php echo U('Task/index',array('cat_id'=>$_GET['cat_id'],'listorder'=>'focus'));?>">最多观看</a>-->
...
<script>
	...
	function getUser() {
		...
		if(ifWeChatLogin == 1) {
			...
			$.get(url, function (res) {
				window.location.href="/index.php/Pc/Article/data_list/channel/xq"
			})
		}
	}
	function  WeChatLogin() {
		...
		$.get(url, function (res) {
			if(res.result == 1) {
				window.location.href="https://open.weixin.qq.com/connect/qrconnect?appid="+res.data['appid']+"&redirect_uri=http://"+res.data['area_name']+"//index.php/Pc/Article/data_list/channel/xq/ifWeChatLogin/1&response_type=code&scope=snsapi_login&state=2015#wechat_redirect";
			} else {
				layer.msg("系统繁忙请稍后再试！");
			}
		})
