	...
	<div class="science_list outside">
		<div class="center">
			<div class="search_form">
				<form action="/index.php/Pc/Index/search">
					<input type="text" class="search_input" maxlength="20" placeholder="请输入关键字" name="keyword"  id="keyword" value="<?php echo ($_GET['keyword']); ?>"/>
			...
			<!--<?php if(empty($results)): ?>-->
				<!--<div class="outside text-center" >-->
					<!--<img src="/Template/5u/pc/Static/img/empty.png"/>-->
					<!--<p class="search_desc">非常抱歉，暂无匹配结果</p>-->
					<!--<div class="search_dire"><a class="active" href="/index.php/Pc/Index/index">返回首页</a></div>-->
				<!--</div>-->
			<!--<?php endif; ?>-->
	...
	var vm = new Vue({
		...
		methods:{
			...
			getData:function (channel) {
				...
				vm.ifbool = channel;
				var _this = this;
				var url = "/<?php echo (API_PATH); ?>/ChannelIndex/index/action/dataList/channel/"+channel+"/type/1";
				vm.url=channel;
			...
			getCount:function (channel,postData) {
				var _this = this;
				var url = "/<?php echo (API_PATH); ?>/ChannelIndex/count/channel/"+channel+"/type/1";
			...
			showDetail:function (id,link) {
				var _this = this;
				if(_this.channel=="hd"){
					window.location.href="/index.php/Pc/Activity/detail/channel/hd/data_id/"+id;
				}else if(_this.channel=="zx"){
					window.location.href=link;
				}else{
					window.location.href="/index.php/Pc/Article/detail/channel/"+_this.channel+"/data_id/"+id;
				}
			},
		}
	});
