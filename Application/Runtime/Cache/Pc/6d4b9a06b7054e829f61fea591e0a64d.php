			...
			<div class="article_tab">
				<ul class="science_tabUl" style="width: 100%;">
					<li class="science_tabLi">
						<a id="yuansuo" class='science_tabLi_a '  href="/index.php/Pc/Article/data_list/channel/hzjg">院所/协会</a>
					</li>

					<li class="science_tabLi">
						<a id="hezuo" class='science_tabLi_a science_tabLi_a_active'  href="/index.php/Pc/Article/data_list/channel/hzqy" onclick="empty()">合作企业</a>
					</li>
				</ul>
			</div>
			<div class="science_list outside" >
				<div class="center">
					...
					<ul class="science_contentUl">
						<li class="science_contentLi" v-for="list in listData"  @click="getDetail(list.id)">
							<img class="company_contentLi_img" v-bind:src="list.cover_url" />
	...
	var vm = new Vue({
		...
		methods:{
			...
			getDetail:function (id) {
				window.location.href="/index.php/Pc/Article/detail/channel/hzqy/type/1/data_id/"+id;
			},
