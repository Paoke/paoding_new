		...
		<div class="center">
			...
			<ul class="science_contentUl">
				<li class="science_contentLi" v-for="list in listData"  @click="getDetail(list.id)">
					...
					<span class="science_contentLi_contenTab" v-text="list.cat_name"></span>
					<span class="science_contentLi_contenTab" v-text="'成熟度:'+list.csd"></span>
...
<script>
	...
	function Contact(url){
		...
		var data={"jumpMessage":content,"jumpName":name,"jumpMobile":mobile,"category_id":category_id};
		$.ajax({
			url:url,
			type:"post",
			data:data,
