	...
	<nav class="navigation">
		<ul class="navigation-list ul-reset">
			<li class="navigation-item ib">
				<a href="/index.php/Pc/Index/index" class='navigation-link <?php if(CONTROLLER_NAME == Index): ?>selected-link<?php endif; ?>'>
					首页
				</a>
			</li>
			<li class="navigation-item ib">
...
<section id="template">
	<div class="science_list outside">
		<div class="center minimum">
			<div class="blog_box">
				<a href="/index.php/Pc/Article/data_list/channel/xq">需求列表 > </a>
				<span>需求详情</span>
			</div>
			<div class="blog">
