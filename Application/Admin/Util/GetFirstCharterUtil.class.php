...
class GetFirstCharterUtil
{
    ...
    /**
     * 取汉字所有拼音
     * @param string $chinese 要转换的汉字  要转换成gbk格式 ：mb_convert_encoding($str, 'gbk', 'utf-8');
    ...
    /**
     * 取一个汉字码对应的拼音
     * @param int $num 汉字码 要转换的汉字  要转换成gbk格式 ：mb_convert_encoding($str, 'gbk', 'utf-8');
