...
class UeditorController extends BaseController
{
    ...
    public function __construct()
    {
      ...
      /*  $res = parent::checkRole();
        if ($res["result"] != 1) {
            ...
            $savePath = $site_name . '/' . I('GET.savepath', 'temp') . '/';
    ...
    public function fileUp()
    {
        $config = array(
            ...
            "exts" => explode(",", 'zip,rar,doc,docx,pdf,txt,ppt,pptx,xls,xlsx'),
    ...
    public function imageUp()
    {
        ...
        $config = array(
            "savePath" => $this->savePath,
            "maxSize" => 20000000, // 单位B
            "exts" => explode(",", 'gif,png,jpg,jpeg,bmp,ico'),
            "subName" => $this->sub_name,
        );
