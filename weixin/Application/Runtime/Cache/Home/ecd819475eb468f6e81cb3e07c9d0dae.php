		...
		<div class="container">
			...
			<div class="row margin-top-30">
					...
					<div class="col-xs-7 col-sm-7 text-left">
						...
						<p><?php echo ($apply["phone"]); ?></p>
						<p><?php echo ($apply["proman_fangshi"]); ?></p>
						<p><?php echo ($apply["proman_time"]); ?></p>
						<p> 500元(人民币)</p>
...
<!--
				<div class="col-xs-12 col-sm-12  margin-top-30 text-center">					
						<a href="http://www.paoding.cc/weixin/weixinpaytest/example/jsapi.php?name=<?php echo ($apply["name"]); ?>&phone=<?php echo ($apply["phone"]); ?>" class="btn btn-red white-link">现在去付款</a>
