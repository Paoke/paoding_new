		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 margin-top-13 text-center">
					<a href="<?php echo U('Protocol/fatask');?>" type="button" class="btn btn-blue  white-link text-center">庖丁技术任务发布协议</a>
				</div>
				<div class="col-xs-12 col-sm-12 margin-top-37 text-center">
					<a href="<?php echo U('Task/fastTask');?>" type="button" id="Next" class="btn btn-next white-link text-center"  style="color:#ddd;" >下一步</a>
				</div>
			</div>
		</div>
