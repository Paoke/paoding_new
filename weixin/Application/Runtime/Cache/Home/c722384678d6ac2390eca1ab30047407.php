		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 margin-top-30 text-center">
					...
					<p class="padding-top-10 gray">工号  <?php echo ($proman_id); ?></p>
				</div>
				<div class="col-xs-12 col-sm-12 text-center margin-top-42">
					<span class="size-30">满意</span>
				</div>
				<div class="col-xs-12 col-sm-12 margin-top-42 text-center">
					<a href="/weixin/index.php/Home/Proman/download/apply_id/<?php echo ($apply_id); ?>" type="button" class="btn btn-red white-link">确认</a>
				</div>
			</div>
		</div>
