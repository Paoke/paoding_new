	...
	<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12">
					<form id="form" action="<?php echo U('Member/register_do');?>" method="post">
						...
						<div class="checkbox text-center">
							<label>
							  <input type="checkbox" class="padding-right-7" checked > 我已阅读<a href="<?php echo U('Member/register_protocol');?>" class="blue-link">《注册协议》</a>并同意
							</label>
						</div>
...
var error = 0;
	$('#submit').on('click',function(){
		...
		if(error ==0){
			...
			$.post("<?php echo U('Member/checkregister');?>",{'username':username,'mobile':mobile,'email':email,'password':password},function(data){
					if(data.u_status == 0){
						if(result != null){
					...
					//	alert(123);
					//	$.ajax({
					//		url: "<?php echo U('Member/register_do');?>",
					//		type: "POST",
					//		data: $('#form').serialize(),
